...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in pyrewall_pb2_grpc.py depends on'
...
class SystemInfoStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetSystemInfo = channel.unary_unary(
                ...
                request_serializer=pyrewall__pb2.voidNoArgs.SerializeToString,
                response_deserializer=pyrewall__pb2.SystemInfoResponse.FromString,
...
def add_SystemInfoServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetSystemInfo': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=pyrewall__pb2.voidNoArgs.FromString,
                    response_serializer=pyrewall__pb2.SystemInfoResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'pyrewall.SystemInfo', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('pyrewall.SystemInfo', rpc_method_handlers)
